  ...
  <div class="panel panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        Reserveren is niet verplicht. Wij adviseren, om teleurstelling te voorkomen, dit wel te doen. Wij kunnen u op deze manier een plaats garanderen. Neemt u contact met ons op om de reservering door te geven.
      </div>
    </div>
  </div>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
            Hebben jullie cadeaubonnen of accepteren jullie dinercheques?
        </a>
      </h4>
    </div>
    <div id="collapse2" class="panel-collapse collapse">
     <div class="panel-body">
        Helaas accepteren wij geen dinercheques/dinerbonnen/VVV bonnen.
     </div>
    </div>
  </div>
