      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title" style="height:25px;">
            ...
            <strong><?php echo date("d-m-Y H:i", strtotime($order['bestelling']['bestel_datumtijd']));?></strong> Gepland:<strong><?php echo date("H:i", strtotime($order['bestelling']['gewenste_moment']));?></strong> - <?php echo $order['bestelling']['voornaam']." ". $order['bestelling']['tussenvoegsel']." ". $order['bestelling']['achternaam'].", ". $order['bestelling']['woonplaats'];?></a>
